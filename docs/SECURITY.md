...
## v0.5.0-beta.1 Auth And Operations Boundary
...
- App-owned end-user anonymization replaces end-user identifiers with tombstone
  ...
  credentials.
- App tokens, API key rotation UI, beta-grade Admin pagination/filtering, and
  production-grade tenant authentication are still planned work.
